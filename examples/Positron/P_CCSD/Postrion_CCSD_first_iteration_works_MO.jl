...
function T1_transform_1e(F, t, o, v)
    ...
    g = fixed_einsum("pr,rs,qs->pq", x, F, y, optimize="optimal")
...
# Correct
function Omega_AI(F, L, h_p , g_p, s, s2, o, v)
    ...
    for B in 2: v[end]
        ...
        S = (fixed_einsum("ia ->", extract_mat(F, "ov", o, v, B),  optimize="optimal"))
        print(S)
        println("F_ov")
...
function build_omega(F, g, g_p, h_p, L, s, t, s2, u, o, v)
    ...
    omega[1 : (v[end]-1)] = Omega_AI(F, L, h_p, g_p, s, s2, o, v)
...
# He         0.10000,       -0.02000,        7.53000", basis="ccPVDZ")
...
function test_1234()
    ...
    if i == j
        ...
        g[i,j,1,o[end]] = - g[i,j,1,o[end]]
        g[i,j,o[end],1] = - g[i,j,o[end],1]

        g[i,j,o[end]+1,1]     = - g[i,j,o[end]+1,1]
        g[i,j,v[end], o[end]] = - g[i,j,v[end], o[end]]

        g[i,j,o[end], v[end]] = - g[i,j, o[end], v[end]]
        g[i,j,1,o[end]+1]     = - g[i,j,1,o[end]+1]

        g[i,j,o[end]+1, v[end]] = - g[i,j, o[end]+1, v[end]]
        g[i,j,v[end], o[end]+1] = - g[i,j, v[end], o[end]+1]
    ...
    g[i,j,v[end],1] = - g[i,j,v[end],1]
    g[i,j,1,v[end]] = - g[i,j,1,v[end]]

    g[i,j,o[end] +1,o[end]]  = - g[i,j,o[end] +1,o[end]]
    g[i,j,o[end] ,o[end]+ 1] = - g[i,j,o[end] ,o[end]+ 1] 

    if  i == 1 || i == 6
        print("yes here we go")
        g[i,j,o[end] +2 ,o[end]]      = - g[i,j,o[end] + 2,o[end]]
        g[i,j,o[end] +2 ,o[end] + 1]  = - g[i,j,o[end] + 2,o[end] + 1]

        g[i,j,o[end],o[end]+ 2]      = - g[i,j,o[end],o[end] + 2]
        g[i,j,o[end] +1,o[end] + 2]  = - g[i,j,o[end] + 1,o[end] + 2]

        g[i,j,o[end] +3 ,o[end]]      = - g[i,j,o[end] + 3,o[end]]
        g[i,j,o[end] +3 ,o[end] + 1]  = - g[i,j,o[end] + 3,o[end] + 1]

        g[i,j,o[end],o[end]+ 3]      = - g[i,j,o[end],o[end] + 3]
        g[i,j,o[end] +1,o[end] + 3]  = - g[i,j,o[end] + 1,o[end] + 3]
    end 

    if i == 3 || i == 4 

        g[i,j, 1 , o[end] + 3]      = - g[i,j,1 , o[end] + 3]
        g[i,j, o[end] + 3 , 1]       = - g[i,j, o[end] +3 , 1]

        g[i,j, 1 , o[end] + 2]      = - g[i,j,1 , o[end] + 2]
        g[i,j, o[end] + 2 , 1]       = - g[i,j, o[end] + 2 , 1]
...
function Density(F_HF, F_p, h_ao, h_p_ao, g_ao, F_prev_p, F_prev, o,)
    ...
    for _ in 1:1000
        ...
        if abs(F_diff) < 10^(-16) && abs(F_diff_p) < 10^(-16)
...
function construct_hf_p()
    ...
    g = zeros(mol.nao, mol.nao, mol.nao, mol.nao)
    h = zeros(mol.nao, mol.nao)
    g, h = sto_3g_g_mo(g, h)
...
#    println("Energy")
    ...
    for i in 1:v[end]
        for j in 1:v[end]
            ...
            ## upper diagonal oo 
            g_p[i,j,1,o[end]] = - g_p[i,j,1,o[end]]
            g_p[i,j,o[end],1] = - g_p[i,j,o[end],1]
            ...
            g_p[i,j,1,o[end]+1] = - g_p[i,j,1,o[end]+1]
            g_p[i,j,1,o[end]+2] = - g_p[i,j,1,o[end]+2]
            g_p[i,j,1,o[end]+3] = - g_p[i,j,1,o[end]+3]
            g_p[i,j,o[end], v[end]] = - g_p[i,j, o[end], v[end]]
                
            ##
            ## g ov 
            ##
            
            g_p[i,j,o[end]+1,1] = - g_p[i,j,o[end]+1,1]
            g_p[i,j,o[end]+2,1] = - g_p[i,j,o[end]+2,1]
            g_p[i,j,o[end]+3,1] = - g_p[i,j,o[end]+3,1]
            g_p[i,j,v[end], o[end]] = - g_p[i,j,v[end], o[end]]
            
            ##
            ## lower diagonal vv 
            ##
            
            g_p[i,j,o[end]+1,v[end]] = - g_p[i,j,o[end]+1,v[end]]
            g_p[i,j,o[end]+2,v[end]] = - g_p[i,j,o[end]+2,v[end]]
            g_p[i,j,o[end]+3,v[end]] = - g_p[i,j,o[end]+3,v[end]]            

            g_p[i,j,v[end],o[end]+1] = - g_p[i,j,v[end],o[end]+1]
            g_p[i,j,v[end],o[end]+2] = - g_p[i,j,v[end],o[end]+2]
            g_p[i,j,v[end],o[end]+3] = - g_p[i,j,v[end],o[end]+3]
...
#    E_P = HF_Energy_p(h_p, g_p, o, v) 
    ...
    return h_p, g_p, F_p, F, L, g, h
end 

h_p, g_p, F_p, F, L, g, h  = construct_hf_p()
...
#exit()
    ...
    #t[v, o] .= 0
        ...
        #gamma =  [0.00000000,   -0.00000000,   -0.00536914,    0.00646127,    0.00002988]
        #gamma =  [-0.00000000,   -0.00000000,   -0.01408430,    0.00839139,    0.00002779]
        ...
        if k % 1 == 0
            println(" --------------Energy at step ", k, " : ", hf.energy_nuc() + CC_Energy(F_t, L_t, g_t, h_pt, g_p, s, u ,o, v))
