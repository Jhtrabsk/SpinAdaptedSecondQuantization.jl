...
function PCC_Energy(F, L, g, h_p, g_p, s, u ,o, v)
...
mol = pyscf.M(atom="H 0.0, 0.0, 0.0; Li 1.606, 0.0, 0.0", basis= "6-31G")
...
# @show isF = fixed_einsum("pqii->pq", L[:, :, o, o], optimize="optiInitial guess for s1
...
#        end 
        ...
        if k % 1 == 0
            println(" --------------Energy at step ", k, " : ", hf.energy_nuc() + PCC_Energy(F_t, L_t, g_t, h_pt, g_pt, s, u ,o, v))
