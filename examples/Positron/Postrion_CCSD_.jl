...
function Omega_AI(F, L, g_p, s, s2, o, v)
    ...
    for B in 2: v[end]
        ...
        Omega_AI[B-1] = Omega_AI[B-1] .+  +2.00000000  * fixed_einsum("ia,ai->", extract_mat(F, "ov", o, v, B), extract_mat(s, "AIvo", o, v, B), optimize="optimal");
...
function construcu_hf_p()
    ...
    F_e  = h + 2*fixed_einsum("pqii -> pq", g[:,:,o,o], optimize="optimal") - fixed_einsum("piiq -> pq", g[:,o,o,:], optimize="optimal")
