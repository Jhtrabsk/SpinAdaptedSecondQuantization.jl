...
function CC_ref_energy(F, g, L, t, t2, o, v)
    # Evaluates Energy = <HF|..H..|HF>
    E = 0.0
    E = E .+  +2.00000000  * np.einsum("ii->", extract_mat(F, "oo", o, v, B), optimize="optimal");
    E = E .+  -1.00000000  * np.einsum("iijj->", extract_mat(L, "oooo", o, v, B), optimize="optimal");
    #E = E .+  +1.00000000  * np.einsum("ia,ai->", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    E = E .+  +1.00000000  * np.einsum("iajb,aibj->", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #E = E .+  +0.25000000  * np.einsum("iajb,ai,bj->", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
...
function Omega_0_bj(F, g, L, t, t2, o, v)
    ...
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +0.50000000  * np.einsum("ab,bi->ai", extract_mat(F, "vv", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.50000000  * np.einsum("ji,aj->ai", extract_mat(F, "oo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +2.00000000  * np.einsum("jb,aibj->ai", extract_mat(F, "ov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -1.00000000  * np.einsum("jb,ajbi->ai", extract_mat(F, "ov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +0.50000000  * np.einsum("aijb,bj->ai", extract_mat(L, "voov", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.25000000  * np.einsum("jb,aj,bi->ai", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +1.00000000  * np.einsum("abjc,bicj->ai", extract_mat(L, "vvov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -1.00000000  * np.einsum("jikb,ajbk->ai", extract_mat(L, "ooov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +0.25000000  * np.einsum("abjc,bi,cj->ai", extract_mat(L, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.25000000  * np.einsum("jikb,aj,bk->ai", extract_mat(L, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.50000000  * np.einsum("jbkc,aj,bick->ai", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.50000000  * np.einsum("jbkc,bi,ajck->ai", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  +1.00000000  * np.einsum("jbkc,bj,aick->ai", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.50000000  * np.einsum("jbkc,bj,akci->ai", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_ai[:,:] = Omega_0_ai[:,:] .+  -0.12500000  * np.einsum("jbkc,aj,bi,ck->ai", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
...
function Omega_0_bjck(F, g, L, t, t2, o, v)
    ...
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("ac,bjci->aibj", extract_mat(F, "vv", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("bc,aicj->aibj", extract_mat(F, "vv", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("ki,akbj->aibj", extract_mat(F, "oo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kj,aibk->aibj", extract_mat(F, "oo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("aibc,cj->aibj", extract_mat(g, "vovv", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("aikj,bk->aibj", extract_mat(g, "vooo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("acbj,ci->aibj", extract_mat(g, "vvvo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("bjki,ak->aibj", extract_mat(g, "vooo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("aikc,bjck->aibj", extract_mat(L, "voov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("bjkc,aick->aibj", extract_mat(L, "voov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("aikc,bkcj->aibj", extract_mat(g, "voov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("acbd,cidj->aibj", extract_mat(g, "vvvv", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("ackj,bkci->aibj", extract_mat(g, "vvoo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("bjkc,akci->aibj", extract_mat(g, "voov", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("bcki,akcj->aibj", extract_mat(g, "vvoo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("kilj,akbl->aibj", extract_mat(g, "oooo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kc,ak,bjci->aibj", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kc,bk,aicj->aibj", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kc,ci,akbj->aibj", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kc,cj,aibk->aibj", extract_mat(F, "ov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("aikc,bk,cj->aibj", extract_mat(g, "voov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("acbd,ci,dj->aibj", extract_mat(g, "vvvv", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("ackj,bk,ci->aibj", extract_mat(g, "vvoo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("bjkc,ak,ci->aibj", extract_mat(g, "voov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("bcki,ak,cj->aibj", extract_mat(g, "vvoo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    ##Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kilj,ak,bl->aibj", extract_mat(g, "oooo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("ackd,ci,bjdk->aibj", extract_mat(L, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("ackd,dk,bjci->aibj", extract_mat(L, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("bckd,cj,aidk->aibj", extract_mat(L, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("bckd,dk,aicj->aibj", extract_mat(L, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kilc,ak,bjcl->aibj", extract_mat(L, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kilc,cl,akbj->aibj", extract_mat(L, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kjlc,bk,aicl->aibj", extract_mat(L, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("kjlc,cl,aibk->aibj", extract_mat(L, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("ackd,bk,cidj->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("ackd,ci,bkdj->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("ackd,dj,bkci->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("bckd,ak,cjdi->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("bckd,cj,akdi->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.50000000  * np.einsum("bckd,di,akcj->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kilc,ak,blcj->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kilc,bl,akcj->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kilc,cj,akbl->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kjlc,al,bkci->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kjlc,bk,alci->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.50000000  * np.einsum("kjlc,ci,albk->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.12500000  * np.einsum("ackd,bk,ci,dj->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.12500000  * np.einsum("bckd,ak,cj,di->aibj", extract_mat(g, "vvov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.12500000  * np.einsum("kilc,ak,bl,cj->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.12500000  * np.einsum("kjlc,al,bk,ci->aibj", extract_mat(g, "ooov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,aibk,cjdl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,aicj,bkdl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +2.00000000  * np.einsum("kcld,aick,bjdl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,aick,bldj->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,akbj,cidl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,akci,bjdl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -1.00000000  * np.einsum("kcld,akdl,bjci->aibj", extract_mat(L, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("kcld,akbl,cidj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("kcld,akci,bldj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
    Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +1.00000000  * np.einsum("kcld,akdj,blci->aibj", extract_mat(g, "ovov", o, v), extract_mat(t2, "vovo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,ak,ci,bjdl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,ak,dl,bjci->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,bk,cj,aidl->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,bk,dl,aicj->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,ci,dl,akbj->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  -0.25000000  * np.einsum("kcld,cj,dl,aibk->aibj", extract_mat(L, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,ak,bl,cidj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,ak,ci,bldj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,ak,dj,blci->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,bk,cj,aldi->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,bk,di,alcj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.25000000  * np.einsum("kcld,ci,dj,akbl->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t2, "vovo", o, v, B), optimize="optimal");
   #Omega_0_aibj[:,:,:,:] = Omega_0_aibj[:,:,:,:] .+  +0.06250000  * np.einsum("kcld,ak,bl,ci,dj->aibj", extract_mat(g, "ovov", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v), extract_mat(t, "vo", o, v, B), optimize="optimal");
...
function Omega_aibj(F, g, g_p, h_p, s, s2, t, u , o, v)
    ...
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("ki,akbj->bjai", extract_mat(F, "oo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kj,aibk->bjai", extract_mat(F, "oo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("ac,cibj->bjai", extract_mat(F, "vv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("bc,cjai->bjai", extract_mat(F, "vv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Aai,Abj->bjai", extract_mat(g_p, "IVvo", o, v), extract_mat(s, "VIvo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Abj,Aai->bjai", extract_mat(g_p, "IVvo", o, v), extract_mat(s, "VIvo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("ki,akbj->bjai", extract_mat(g_p, "IIoo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kj,aibk->bjai", extract_mat(g_p, "IIoo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("ac,cibj->bjai", extract_mat(g_p, "IIvv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("bc,cjai->bjai", extract_mat(g_p, "IIvv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("A,Aaibj->bjai", extract_mat(h_p, "IV", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kiac,bjck->bjai", extract_mat(g, "oovv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kibc,akcj->bjai", extract_mat(g, "oovv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kilj,akbl->bjai", extract_mat(g, "oooo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kjac,bkci->bjai", extract_mat(g, "oovv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kjbc,aick->bjai", extract_mat(g, "oovv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("acbd,cidj->bjai", extract_mat(g, "vvvv", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcai,bjck->bjai", extract_mat(g, "ovvo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcbj,aick->bjai", extract_mat(g, "ovvo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Aac,Abjci->bjai", extract_mat(g_p, "IVvv", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Abc,Aaicj->bjai", extract_mat(g_p, "IVvv", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Aki,Aakbj->bjai", extract_mat(g_p, "IVoo", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Akj,Aaibk->bjai", extract_mat(g_p, "IVoo", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -2.00000000  * fixed_einsum("Akk,Aaibj->bjai", extract_mat(g_p, "IVoo", o, v), extract_mat(s2, "VIvovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Akc,Aak,bjci->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Akc,Abk,aicj->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Akc,Aci,akbj->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("Akc,Acj,aibk->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Akc,Aai,bjck->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("Akc,Abj,aick->bjai", extract_mat(g_p, "IVov", o, v), extract_mat(s, "VIvo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcld,akbl,cidj->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcld,akdj,blci->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcld,aicl,bkdj->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(t, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kcld,akbj,cidl->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kcld,aibk,cjdl->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kcld,aicj,bkdl->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kcld,bjci,akdl->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  -1.00000000  * fixed_einsum("kcld,bjcl,aidk->bjai", extract_mat(g, "ovov", o, v), extract_mat(t, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
    Omega_bjai[:,:,:,:] = Omega_bjai[:,:,:,:] .+  +1.00000000  * fixed_einsum("kcld,aick,bjdl->bjai", extract_mat(g, "ovov", o, v), extract_mat(u, "vovo", o, v), extract_mat(u, "vovo", o, v, B), optimize="optimal");
...
mol = pyscf.M(atom= "H,          0.86681,        0.60144,        5.00000;
 ...
 He         0.10000,       -0.02000,        7.53000", basis="sto-6g")
...
# s[3:10,1:2] += reshape(Omega(for the s), nv, no)
        ...
        global t2[v, o, v, o] += reshape(amplitudes[v[end] + n + n*(v[end]-1):  v[end] - 1 + n + n*(v[end]-1) + n^2], (nv, no, nv, no)) ./ (pre_t2[v, o, v, o]*2)
        display(t2[v, o, v, o])
        println("t2")
        ...
        # T1 - transform integrals
         ...
         global g_pt = T1_transform_g_p_2e(g_p,  t[v,o],  o, v)
         global g_pt = Gamma_transform_2e( g_pt, gamma,  o, v)
        ...
        if sqrt(sum([abs(e)^2 for (l, e) in enumerate(amplitudes) if l != n^2+2*n+2+(v[end]-o[end])^2*o[end]*(o[end]-1)+(v[end]-o[end])*(o[end]-1)])) < 1e-12
            println("Converged!")
            break
        end
    end
